execute unless score &no_player_on_horse call_your_horse.config = &no_player_on_horse call_your_horse.config run data modify storage call_your_horse:root data.no_player_on_horse set value 1

execute unless score &no_player_on_horse call_your_horse.config = &no_player_on_horse call_your_horse.config run scoreboard players set &no_player_on_horse call_your_horse.config 1
...
execute unless score &horse_callable_without_owner call_your_horse.config = &horse_callable_without_owner call_your_horse.config run data modify storage call_your_horse:root data.horse_callable_without_owner set value 0

execute unless score &donkey_callable_without_owner call_your_horse.config = &donkey_callable_without_owner call_your_horse.config run data modify storage call_your_horse:root data.donkey_callable_without_owner set value 0

execute unless score &mule_callable_without_owner call_your_horse.config = &mule_callable_without_owner call_your_horse.config run data modify storage call_your_horse:root data.mule_callable_without_owner set value 0

execute unless score &llama_callable_without_owner call_your_horse.config = &llama_callable_without_owner call_your_horse.config run data modify storage call_your_horse:root data.llama_callable_without_owner set value 0

execute unless score &trader_llama_callable_without_owner call_your_horse.config = &trader_llama_callable_without_owner call_your_horse.config run data modify storage call_your_horse:root data.trader_llama_callable_without_owner set value 0

execute unless score &skeleton_horse_callable_without_owner call_your_horse.config = &skeleton_horse_callable_without_owner call_your_horse.config run data modify storage call_your_horse:root data.skeleton_horse_callable_without_owner set value 1

execute unless score &camel_callable_without_owner call_your_horse.config = &camel_callable_without_owner call_your_horse.config run data modify storage call_your_horse:root data.camel_callable_without_owner set value 1

execute unless score &zombie_horse_callable_without_owner call_your_horse.config = &zombie_horse_callable_without_owner call_your_horse.config run data modify storage call_your_horse:root data.zombie_horse_callable_without_owner set value 1
...
execute unless score &horse_callable_without_owner call_your_horse.config = &horse_callable_without_owner call_your_horse.config run scoreboard players set &horse_callable_without_owner call_your_horse.config 0

execute unless score &donkey_callable_without_owner call_your_horse.config = &donkey_callable_without_owner call_your_horse.config run scoreboard players set &donkey_callable_without_owner call_your_horse.config 0

execute unless score &mule_callable_without_owner call_your_horse.config = &mule_callable_without_owner call_your_horse.config run scoreboard players set &mule_callable_without_owner call_your_horse.config 0

execute unless score &llama_callable_without_owner call_your_horse.config = &llama_callable_without_owner call_your_horse.config run scoreboard players set &llama_callable_without_owner call_your_horse.config 0

execute unless score &trader_llama_callable_without_owner call_your_horse.config = &trader_llama_callable_without_owner call_your_horse.config run scoreboard players set &trader_llama_callable_without_owner call_your_horse.config 0

execute unless score &skeleton_horse_callable_without_owner call_your_horse.config = &skeleton_horse_callable_without_owner call_your_horse.config run scoreboard players set &skeleton_horse_callable_without_owner call_your_horse.config 1

execute unless score &zombie_horse_callable_without_owner call_your_horse.config = &zombie_horse_callable_without_owner call_your_horse.config run scoreboard players set &zombie_horse_callable_without_owner call_your_horse.config 1

execute unless score &camel_callable_without_owner call_your_horse.config = &camel_callable_without_owner call_your_horse.config run scoreboard players set &camel_callable_without_owner call_your_horse.config 1