...
$data modify storage call_your_horse:root data.camel_husk_callable set value $(dialog_camel_husk_callable)
...
$scoreboard players set &camel_husk_callable call_your_horse.config $(dialog_camel_husk_callable)
