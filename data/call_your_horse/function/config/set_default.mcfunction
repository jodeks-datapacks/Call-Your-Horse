execute unless data storage call_your_horse:root data.no_player_on_mount run data modify storage call_your_horse:root data.no_player_on_mount set value 1
...
execute unless data storage call_your_horse:root data.mount_automatically run data modify storage call_your_horse:root data.mount_automatically set value 0
...
execute unless data storage call_your_horse:root data.horse_callable run data modify storage call_your_horse:root data.horse_callable set value 1
...
execute unless data storage call_your_horse:root data.donkey_callable run data modify storage call_your_horse:root data.donkey_callable set value 1
...
execute unless data storage call_your_horse:root data.mule_callable run data modify storage call_your_horse:root data.mule_callable set value 1
...
execute unless data storage call_your_horse:root data.llama_callable run data modify storage call_your_horse:root data.llama_callable set value 1
...
execute unless data storage call_your_horse:root data.trader_llama_callable run data modify storage call_your_horse:root data.trader_llama_callable set value 1
...
execute unless data storage call_your_horse:root data.skeleton_horse_callable run data modify storage call_your_horse:root data.skeleton_horse_callable set value 1
...
execute unless data storage call_your_horse:root data.zombie_horse_callable run data modify storage call_your_horse:root data.zombie_horse_callable set value 1
