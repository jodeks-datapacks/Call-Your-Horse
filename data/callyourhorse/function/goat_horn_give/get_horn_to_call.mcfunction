...
# compare both UUIDs
data modify storage callyourhorse:root UUID set from entity @e[predicate=callyourhorse:horse_selector_callable,limit=1,tag=horse_to_call] Owner
...
execute if entity @e[predicate=callyourhorse:horse_selector_callable,limit=1,tag=horse_to_call] if entity @e[limit=1,tag=horse_to_call,predicate=callyourhorse:horse_selector_callable_without_owner] run scoreboard players set &UUID_check check.callyourhorse 0
...
# get horse name
execute if score &UUID_check check.callyourhorse matches 0 run data modify storage callyourhorse:root horse_name set from entity @e[limit=1,tag=horse_to_call] CustomName

# execute give goat horn
execute if score &UUID_check check.callyourhorse matches 0 run execute as @s at @s if entity @e[limit=1,tag=horse_to_call] run function callyourhorse:goat_horn_give/goat_horn_give_macro with storage callyourhorse:root
