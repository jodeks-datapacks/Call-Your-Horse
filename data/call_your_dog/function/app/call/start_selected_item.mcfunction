advancement revoke @s only call_your_dog:used/goat_horn_selected

scoreboard players set &UUID_check call_your_dog.check 1

execute as @s run function jodek:api/data/get/selected_item_stored_uuid with storage call_your_dog:root data
...
execute as @s run function call_your_dog:app/call/get_data with storage call_your_dog:root data